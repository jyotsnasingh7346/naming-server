...
public class NamingServerApplication {
	 ...
	 * 
	 * Step 02 : Launch the Naming Server (this application) & the registered application, and 
	 * you should find the registered apps on the eureka server.
	 * 
	 * Step 03 : In the application.properties of all the registered applications, add their eureka client :
